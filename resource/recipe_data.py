...
custom_recipe_data = {
    "techreborn": {
        ...
        "extractor": {
            ...
            .build(),
            "30_double_flowers_0": CustomRecipeBuilder(
            ...
            .with_output(Ingredient.item("dye", metadata=11, count=2))
            .build(),
            "30_double_flowers_1": CustomRecipeBuilder(
                recipe_type="techreborn:extractor"
            )
            .with_time(400)
            .with_energy(8)
            ...
            .with_output(Ingredient.item("dye", metadata=13, count=2))
            .build(),
            "30_double_flowers_2": CustomRecipeBuilder(
                recipe_type="techreborn:extractor"
            )
            .with_time(400)
            .with_energy(8)
            ...
            .build(),
            "30_double_flowers_3": CustomRecipeBuilder(
                recipe_type="techreborn:extractor"
            )
            .with_time(400)
            .with_energy(8)
