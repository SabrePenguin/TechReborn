...
import com.sabrepenguin.techreborn.jei.wrappers.ScrapboxRecipeWrapper;
...
public class ScrapboxCategory implements IRecipeCategory<ScrapboxRecipeWrapper> {
	...
	public ScrapboxCategory(IGuiHelper helper, String uid) {
		background = helper.createBlankDrawable(70, 26);
		this.uid = uid;
