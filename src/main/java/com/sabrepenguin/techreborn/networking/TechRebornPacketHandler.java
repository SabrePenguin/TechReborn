...
import com.sabrepenguin.techreborn.networking.debug.PacketHighlightDebug;
...
public class TechRebornPacketHandler {
	...
	public static void init() {
		...
		INSTANCE.registerMessage(PacketHighlightDebug.PacketHighlightDebugMessageHandler.class, PacketHighlightDebug.class, 2, Side.CLIENT);
		INSTANCE.registerMessage(PacketServerHighlightDebug.PacketServerHandler.class, PacketServerHighlightDebug.class, 3, Side.SERVER);
	}
}
